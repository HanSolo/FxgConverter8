            ...
            @Override public void handle(DragEvent dragEvent) {
                ...
                if (uri != null) {
                    try {
                        ...
                        dirWatcher = new DirectoryWatcher(fxgFileToWatch);
                        dirWatcher.setOnFileModified(new EventHandler<WatcherEvent>() {
                        ...
                        dirWatcher.setOnFileRemoved(new EventHandler<WatcherEvent>() {
                            @Override public void handle(WatcherEvent watcherEvent) {
